...
main()
{
    ...
    level.turret_heat_max = 100000000;
    level.turret_heat_maxshots = 100000000;
    level.turret_cooldownrate = 150;
    level.overheat_hud_height_max = 100000000;
...
nuke_flight()
{
    ...
    level.cobrapilot maps\_custom_utility::detach_all_attachments(); //here
    ...
    level.cobrapilot maps\_custom_utility::attach_all_attachments(); //here
    ...
    var_6 maps\_custom_utility::swap_character( level.cobrapilot );  //here
    var_6 setcontents( 0 );
    var_6.ignoreme = 1;
...
monitor_price_name()
{
    ...
    // for(;;)
    // {
    //     if( isdefined( level.price || level.waters ) )
    //         level.price.name = "General Shepherd";
    //         level.griggs.name = "Sgt. Dunn";
        
    //     wait 0.5;
    // }
    for(;;)
    {
        "Lt. Vasquez - Shadow Company";
        wait 0.5;
    }
}