...
main()
{
    ...
    else
    {
        ...
        level.scr_model["carry_price"] = "worldbody_h1_sas_woodland";
...
player_rappel()
{
    ...
    level.scr_model["player_grab_barret"] = "viewhands_player_tf141";
    ...
    if ( getdvarint( "use_old_crash_pickup" ) == 1 )
    {
        level.scr_model["player_carry"] = "viewhands_player_tf141";
